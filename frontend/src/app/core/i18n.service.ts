...
const STRINGS: Record<'en' | 'de', Record<string, string>> = {
  en: {
    ...
    realResultsBody: 'A real Booking.com search for your dates, group, and filters — opens in a new tab.',
    searchOnBooking: 'Search on Booking.com',
    realResultsUnavailable: "We couldn't put together a live search link yet — try going back a step.",
    ...
    checkFlightPrices: '✈ Check flight prices (opens Booking.com Flights)',
    search: 'Search',
    backToSession: '← Back to your session (change a smaller detail instead)',
    budgetExcludesFlightNote: "** Doesn't include the flight — prices change too much day to day for us to estimate honestly. We'll link you to a live search once we know where you're headed.",
  ...
  de: {
    ...
    realResultsBody: 'Eine echte Booking.com-Suche für deine Daten, Gruppe und Filter — öffnet sich in einem neuen Tab.',
    searchOnBooking: 'Auf Booking.com suchen',
    realResultsUnavailable: 'Wir konnten noch keinen Live-Suchlink erstellen — versuch einen Schritt zurückzugehen.',
    ...
    checkFlightPrices: '✈ Flugpreise prüfen (öffnet Booking.com Flights)',
    search: 'Suchen',
    backToSession: '← Zurück zu deiner Sitzung (stattdessen eine Kleinigkeit ändern)',
    budgetExcludesFlightNote: '** Ohne Flug — die Preise ändern sich täglich zu stark, um sie ehrlich zu schätzen. Sobald wir dein Ziel kennen, verlinken wir dir eine Live-Suche.',
